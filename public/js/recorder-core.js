...
!(function (y) {
  ...
  A[k] = !1;
  var d = function (e) {
      var t = (e = e || A).BufferSize || A.BufferSize,
        r = A.Ctx,
        n = e.Stream,
        a = (n._m = r.createMediaStreamSource(n)),
        u = n._call,
        o = function (e, t) {
          if (!t || h)
            for (var n in u) {
              for (
                var r = t || e.inputBuffer.getChannelData(0),
                  a = r.length,
                  o = new Int16Array(a),
                  s = 0,
                  i = 0;
          ...
          _ = (n._na = function () {
            '' !== g &&
              ...
              (g = setTimeout(function () {
                (g = 0),
                  M(l + '未返回任何音频，恢复使用' + s, 3),
                  S() && p && m();
              }, 500)));
          }),
          C = function () {
            if (S()) {
              var e = (n._n = new d(r, f, {
                processorOptions: { bufferSize: t },
              }));
              a.connect(e),
                e.connect(r.destination),
          ...
          if (S())
            if (r[f]) C();
              ...
              var e,
                t,
                n =
                  ((t = 'class ' + f + ' extends AudioWorkletProcessor{'),
                  (t +=
                    'constructor ' +
                    (e = function (e) {
                      return e
                      ...
                      DEL_super(e);
                      var t = this,
                        n = e.processorOptions.bufferSize;
                      (t.bufferSize = n),
                        (t.buffer = new Float32Array(2 * n)),
                        (t.pos = 0),
    ...
    g = function (e) {
      ...
      if (
        n &&
        (n._m && (n._m.disconnect(), (n._m = null)),
        n._p && (n._p.disconnect(), (n._p.onaudioprocess = n._p = null)),
        I(n),
        t)
      ) {
        for (
          var r = (n.getTracks && n.getTracks()) || n.audioTracks || [], a = 0;
          a < r.length;
          a++
        ) {
          var o = r[a];
  ...
  (A.SampleData = function (e, t, n, r, a) {
    ...
    for (var p = new Int16Array(f), v = 0, u = 0; u < i.length; u++)
      (p[v] = i[u]), v++;
    ...
    if (0 < k) {
      var I = 2 * (p.length - k);
      (i = new Int16Array(p.buffer.slice(I))),
    ...
    (A.PowerLevel = function (e, t) {
      ...
      return n < 1251
        ...
        : Math.round(
            Math.min(
              100,
              Math.max(0, 100 * (1 + Math.log(n / 1e4) / Math.log(10))),
            ),
          );
    });
  var M = function (e, t) {
    ...
    (A.prototype = t.prototype =
      {
        ...
        open: function (e, n) {
          ...
          var a = function (e, t) {
              (t = !!t),
                r.CLog('录音open失败：' + e + ',isUserNotAllow:' + t, 1),
                n && n(e, t);
            },
            o = function () {
          ...
          if (u) a('不能录音：' + u);
            ...
            if (A.IsOpen()) o();
              ...
              var p = function (e) {
                ...
                m = A.Scope.getUserMedia(
                  { audio: r.set.audioTrackSet || !0 },
                  p,
                  v,
                );
        ...
        envStart: function (e, t) {
          ...
          if (
            ...
            (n.envInFix = 0),
            (n.envInFixTs = []),
            (r.sampleRate = Math.min(t, r.sampleRate)),
            (n.srcSampleRate = t),
            (n.engineCtx = 0),
            n[r.type + '_start'])
          ) {
            ...
            z = function () {
              for (var e = O ? 0 : -x, t = null == c[0], n = f; n < w; n++) {
                ...
                null == r
                  ? (t = 1)
                  : ((e += r.length),
                    s && r.length && a[o.type + '_encode'](s, r));
              }
              if (t && s) for (n = l, u[0] && (n = 0); n < T; n++) u[n] = null;
              t && ((e = O ? x : 0), (c[0] = null)),
                s ? (s.pcmSize += e) : (a.recSize += e);
            },
            O = o.onProcess(c, i, L, n, f, z);
          if (!0 === O) {
            var D = 0;
            for (g = f; g < w; g++)
              null == c[g] ? (D = 1) : (c[g] = new Int16Array(0));
            D
        ...
        start: function () {
          var e = this,
            ...
            n = 1;
          if (
            (e.set.sourceStream ? e.Stream || (n = 0) : A.IsOpen() || (n = 0),
            n)
          )
            if (
              (e.CLog('开始录音'),
        ...
        _stop: function (e) {
          ...
          t.isMock || t._S++,
            ...
            !e &&
              t[n.type + '_stop'] &&
              (t[n.type + '_stop'](t.engineCtx), (t.engineCtx = 0));
        },
        stop: function (n, t, e) {
          var r,
            a = this,
          ...
          a.CLog(
            'stop ' +
              (a.envInLast
                ? a.envInLast - a.envInFirst + 'ms 补' + a.envInFix + 'ms'
                : '-'),
          );
          var s = function () {
              a._stop(), e && a.close();
          ...
          if (u)
            if (a.buffers[0])
              if (a[o.type]) {
                ...
                var h = m.data;
                (v = Math.round((h.length / o.sampleRate) * 1e3)),
                  a.CLog(
                    '采样' +
                      u +
                      '->' +
              ...
              } else i('未加载' + o.type + '编码器');
            else i('音频buffers被释放');
          else i('未采集到录音');
        },
      }),
    y.Recorder && y.Recorder.Destroy(),
    ((y.Recorder = A).LM = '2022-03-05 11:53:19'),
    (A.TrafficImgUrl = '//ia.51.la/go1?id=20469973&pvFlag=1'),
    (A.Traffic = function () {
      ...
      if (e) {
        ...
        if (
          (0 == e.indexOf('//') &&
            (e = /^https:/i.test(n) ? 'https:' + e : 'http:' + e),
          !t[n])
        ) {
          t[n] = 1;
          var r = new Image();
